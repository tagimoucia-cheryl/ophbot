...
# Create a filter that identifies patients/visits etc that have ever received NIV
...
# Configuration
# *************
rlang::inform('--- Starting to build NIV_FILTER table')
...
query <- readr::read_file('sql/view_niv_filter.sql')
